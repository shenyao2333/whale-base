...
import com.whale.base.annotation.Excel;
import com.whale.base.annotation.Excels;
...
public class ExcelUtil<T> {
    ...
    public R exportEasyExcel(List<T> list, String sheetName){
        String filename = encodingFilename(sheetName);
        String absoluteFile = getAbsoluteFile(filename);
        EasyExcel.write(absoluteFile, clazz).sheet(sheetName).doWrite(list);
