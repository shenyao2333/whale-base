  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属应用" prop="applications">
          <el-checkbox-group v-model="form.applications"  @change="applicationsChange">
            <el-checkbox   v-for="application in applicationOptions" :label="application.id" :key="application.id">
              {{application.name}}
            </el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm" :loading="buttonStatus">确 定</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 查询菜单树结构 */
      getMenuTree() {
       let appids =  this.form.applications.join();
        menuTree({applicationIds:appids}).then(response => {
      ...
      handleEdit(row) {
        ...
        getRole(id).then(response => {
          ...
          this.form.applications = this.applicationOptions.map(item => item.id );
          this.open = true;
          this.title = "修改角色";
        });
      },
      ...
      submitForm: function () {
        this.$refs["form"].validate(valid => {
          if (valid) {
            ...
            console.log("状态修改："+ this.buttonStatus)
      ...
      applicationsChange(){
        console.log("applications:"+this.form.applications);
        console.log("applicationOptions"+ this.applicationOptions);
        this.getMenuTree();
      }
    }
  };
