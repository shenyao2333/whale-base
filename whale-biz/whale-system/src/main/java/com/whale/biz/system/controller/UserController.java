...
import com.whale.biz.system.service.*;
import com.whale.biz.system.vo.ResultVo;
import com.whale.biz.system.vo.UserVo;
...
public class UserController {
    ...
    public R profile() {
        ...
        if (whaleUser != null) {
            User user = userService.getById(whaleUser.getId() + "");
            if (user != null) {
    ...
    public R updateAvatar(@RequestParam("avatarfile") MultipartFile file, HttpServletRequest request) {
        String avatar = uploadFileUtil.upload(file);
